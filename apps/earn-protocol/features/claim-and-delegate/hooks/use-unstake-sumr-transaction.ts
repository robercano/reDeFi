...
import { ERROR_TOAST_CONFIG, getAccountType, SUCCESS_TOAST_CONFIG } from '@thesolidchain/app-earn-ui'
import { NetworkIds, type TransactionWithStatus } from '@thesolidchain/app-types'
import { User } from '@thesolidchain/sdk-common'
