...
[redefi](../../../README.md) / [client/src](../README.md) / ISparkProtocol
...
- [`ISparkProtocolData`](../../../protocol-plugins/service/src/type-aliases/ISparkProtocolData.md).[`IProtocol`](IProtocol.md)
...
> `readonly` **name**: [`Spark`](../enumerations/ProtocolName.md#spark)
