...
[redefi](../../../README.md) / [client/src](../README.md) / IMakerProtocol
...
- [`IProtocol`](IProtocol.md).[`IMakerProtocolData`](../../../protocol-plugins/service/src/type-aliases/IMakerProtocolData.md)
...
> `readonly` **name**: [`Maker`](../enumerations/ProtocolName.md#maker)
