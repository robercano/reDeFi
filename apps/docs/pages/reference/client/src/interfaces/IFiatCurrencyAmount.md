...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `fiatToSubtract` | `IFiatCurrencyAmount` | FiatCurrencyAmount to subtract |
...
| `params.decimals?` | `number` | The number of decimals used to represent the value in Solidity |
