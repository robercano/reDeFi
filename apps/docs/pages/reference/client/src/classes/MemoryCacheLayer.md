...
> **get**\<`T`\>(`key`, `strategy`): `Promise`\<`T` \| `null`\>
...
| `strategy` | [`InvalidationStrategy`](../type-aliases/InvalidationStrategy.md) | The invalidation strategy to determine if the key is stale. |
...
| `strategy?` | [`InvalidationStrategy`](../type-aliases/InvalidationStrategy.md) | Optional strategy to determine when to invalidate. |
