...
[redefi](../../../README.md) / [client/src](../README.md) / SparkProtocol
...
> `readonly` **name**: [`Spark`](../enumerations/ProtocolName.md#spark) = `ProtocolName.Spark`
...
| Parameter | Type |
| ------ | ------ |
| `params` | [`SparkProtocolParameters`](../../../protocol-plugins/service/src/type-aliases/SparkProtocolParameters.md) |
