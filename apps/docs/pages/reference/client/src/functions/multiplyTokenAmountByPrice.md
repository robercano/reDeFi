...
> **multiplyTokenAmountByPrice**(`tokenAmount`, `price`): `Readonly`\<\{ `amount`: `string`; `token`: [`IToken`](../interfaces/IToken.md); \}\> \| `Readonly`\<\{ `amount`: `string`; `fiat`: [`FiatCurrency`](../enumerations/FiatCurrency.md); \}\>
