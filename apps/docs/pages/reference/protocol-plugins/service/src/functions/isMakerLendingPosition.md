...
[redefi](../../../../README.md) / [protocol-plugins/service/src](../README.md) / isMakerLendingPosition

# Function: isMakerLendingPosition()
...
| ------ | ------ | ------ |
| `maybeMakerLendingPosition` | `unknown` | Object to be checked |
