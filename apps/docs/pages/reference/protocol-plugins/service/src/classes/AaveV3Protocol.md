...
> `readonly` **name**: [`AaveV3`](../../../../client/src/enumerations/ProtocolName.md#aavev3) = `ProtocolName.AaveV3`
...
| Parameter | Type |
| ------ | ------ |
| `params` | [`AaveV3ProtocolParameters`](../type-aliases/AaveV3ProtocolParameters.md) |
