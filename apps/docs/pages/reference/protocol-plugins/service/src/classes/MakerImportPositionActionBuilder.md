...
[redefi](../../../../README.md) / [protocol-plugins/service/src](../README.md) / MakerImportPositionActionBuilder

# Class: MakerImportPositionActionBuilder

## Extends

- `BaseActionBuilder`\<[`ImportStep`](../../../../client/src/namespaces/steps/type-aliases/ImportStep.md)\>

## Constructors

### Constructor

> **new MakerImportPositionActionBuilder**(): `MakerImportPositionActionBuilder`
...
`BaseActionBuilder<steps.ImportStep>.constructor`
...
| ------ | ------ | ------ |
| `params` | \{ `actionBuilderParams`: `ActionBuilderParams`\<[`ImportStep`](../../../../client/src/namespaces/steps/type-aliases/ImportStep.md)\>; `protocolName`: [`ProtocolName`](../../../../client/src/enumerations/ProtocolName.md); \} | - |
| `params.actionBuilderParams` | `ActionBuilderParams`\<[`ImportStep`](../../../../client/src/namespaces/steps/type-aliases/ImportStep.md)\> | The parameters for the action builder |
...
| Parameter | Type |
| ------ | ------ |
| `params` | `ActionBuilderParams`\<[`ImportStep`](../../../../client/src/namespaces/steps/type-aliases/ImportStep.md)\> |
