...
| `params.actionBuilderParams` | `ActionBuilderParams`\<[`SkippedStep`](../../../../client/src/namespaces/steps/type-aliases/SkippedStep.md)\> | The parameters for the action builder |
