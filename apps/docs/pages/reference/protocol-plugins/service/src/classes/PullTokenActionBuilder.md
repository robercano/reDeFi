...
| ------ | ------ | ------ |
| `params` | \{ `actionBuilderParams`: `ActionBuilderParams`\<[`PullTokenStep`](../../../../client/src/namespaces/steps/type-aliases/PullTokenStep.md)\>; `protocolName`: [`ProtocolName`](../../../../client/src/enumerations/ProtocolName.md); \} | - |
| `params.actionBuilderParams` | `ActionBuilderParams`\<[`PullTokenStep`](../../../../client/src/namespaces/steps/type-aliases/PullTokenStep.md)\> | The parameters for the action builder |
