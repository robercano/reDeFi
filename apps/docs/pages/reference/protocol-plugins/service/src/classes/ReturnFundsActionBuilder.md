...
[redefi](../../../../README.md) / [protocol-plugins/service/src](../README.md) / ReturnFundsActionBuilder

# Class: ReturnFundsActionBuilder

## Extends

- `BaseActionBuilder`\<[`ReturnFundsStep`](../../../../client/src/namespaces/steps/type-aliases/ReturnFundsStep.md)\>

## Constructors

### Constructor

> **new ReturnFundsActionBuilder**(): `ReturnFundsActionBuilder`
...
| ------ | ------ | ------ |
| `params` | \{ `actionBuilderParams`: `ActionBuilderParams`\<[`ReturnFundsStep`](../../../../client/src/namespaces/steps/type-aliases/ReturnFundsStep.md)\>; `protocolName`: [`ProtocolName`](../../../../client/src/enumerations/ProtocolName.md); \} | - |
| `params.actionBuilderParams` | `ActionBuilderParams`\<[`ReturnFundsStep`](../../../../client/src/namespaces/steps/type-aliases/ReturnFundsStep.md)\> | The parameters for the action builder |
...
| Parameter | Type |
| ------ | ------ |
| `params` | `ActionBuilderParams`\<[`ReturnFundsStep`](../../../../client/src/namespaces/steps/type-aliases/ReturnFundsStep.md)\> |
