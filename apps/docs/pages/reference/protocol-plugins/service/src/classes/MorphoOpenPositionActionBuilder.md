...
[redefi](../../../../README.md) / [protocol-plugins/service/src](../README.md) / MorphoOpenPositionActionBuilder

# Class: MorphoOpenPositionActionBuilder

## Extends

- `BaseActionBuilder`\<[`OpenPosition`](../../../../client/src/namespaces/steps/type-aliases/OpenPosition.md)\>

## Constructors

### Constructor

> **new MorphoOpenPositionActionBuilder**(): `MorphoOpenPositionActionBuilder`
...
| `params.actionBuilderParams` | `ActionBuilderParams`\<[`OpenPosition`](../../../../client/src/namespaces/steps/type-aliases/OpenPosition.md)\> | The parameters for the action builder |
...
| Parameter | Type |
| ------ | ------ |
| `params` | `ActionBuilderParams`\<[`OpenPosition`](../../../../client/src/namespaces/steps/type-aliases/OpenPosition.md)\> |
