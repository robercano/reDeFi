...
[redefi](../../../../README.md) / [protocol-plugins/service/src](../README.md) / SwapActionBuilder

# Class: SwapActionBuilder

## Extends

- `BaseActionBuilder`\<[`SwapStep`](../../../../client/src/namespaces/steps/type-aliases/SwapStep.md)\>

## Constructors

### Constructor

> **new SwapActionBuilder**(): `SwapActionBuilder`
...
| ------ | ------ | ------ |
| `params` | \{ `actionBuilderParams`: `ActionBuilderParams`\<[`SwapStep`](../../../../client/src/namespaces/steps/type-aliases/SwapStep.md)\>; `protocolName`: [`ProtocolName`](../../../../client/src/enumerations/ProtocolName.md); \} | - |
| `params.actionBuilderParams` | `ActionBuilderParams`\<[`SwapStep`](../../../../client/src/namespaces/steps/type-aliases/SwapStep.md)\> | The parameters for the action builder |
...
| Parameter | Type |
| ------ | ------ |
| `params` | `ActionBuilderParams`\<[`SwapStep`](../../../../client/src/namespaces/steps/type-aliases/SwapStep.md)\> |
