        ...
        <div className="p-6 rounded-xl bg-black/60 border border-[var(--neon-orange)]/30 backdrop-blur-md shadow-[0_0_15px_rgba(255,85,0,0.1)] relative overflow-hidden group">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-neutral-400 font-mono text-xs mt-1 truncate max-w-[200px] sm:max-w-xs">{tokenData.address?.value}</p>
            </div>
          </div>
          
          <div className="grid grid-cols-2 gap-4 mt-6">
            <div className="bg-neutral-900/80 p-3 rounded-lg border border-neutral-800">
              <span className="text-xs text-neutral-500 uppercase tracking-wider font-semibold block mb-1">Decimals</span>
              <span className="font-mono text-white text-lg">{tokenData.decimals}</span>
            </div>
            {tokenData.chainInfo && (
              <div className="bg-neutral-900/80 p-3 rounded-lg border border-neutral-800">
                <span className="text-xs text-neutral-500 uppercase tracking-wider font-semibold block mb-1">Chain ID</span>
            ...
            <div className="bg-neutral-900/80 p-3 rounded-lg border border-neutral-800 col-span-2 overflow-x-auto">
                <span className="text-xs text-neutral-500 uppercase tracking-wider font-semibold block mb-2">Raw JSON</span>
