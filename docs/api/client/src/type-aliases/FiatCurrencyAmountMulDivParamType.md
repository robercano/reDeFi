...
[redefi](../../../README.md) / [client/src](../README.md) / FiatCurrencyAmountMulDivParamType

# Type Alias: FiatCurrencyAmountMulDivParamType

> **FiatCurrencyAmountMulDivParamType** = `string` \| `number` \| [`IPrice`](../interfaces/IPrice.md) \| [`IPercentage`](../interfaces/IPercentage.md)
