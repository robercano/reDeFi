...
[redefi](../../../README.md) / [client/src](../README.md) / IPercentage
...
- [`IPercentageData`](../type-aliases/IPercentageData.md).`IValueConverter`.[`IPrintable`](../../../common/src/interfaces/IPrintable.md)
