...
[redefi](../../../README.md) / [client/src](../README.md) / IAddress
...
- [`IAddressData`](../type-aliases/IAddressData.md).[`IPrintable`](../../../common/src/interfaces/IPrintable.md).`ISolidityValue`\<[`AddressValue`](../type-aliases/AddressValue.md)\>
...
> `readonly` **type**: [`AddressType`](../../../common/src/enumerations/AddressType.md)
