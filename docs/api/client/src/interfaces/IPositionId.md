...
[redefi](../../../README.md) / [client/src](../README.md) / IPositionId
...
- [`IYieldPositionId`](IYieldPositionId.md)
...
> `readonly` **type**: [`PositionType`](../../../common/src/enumerations/PositionType.md)
