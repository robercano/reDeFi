...
[redefi](../../README.md) / subscriptions/service/src

# subscriptions/service/src
...
> **new SubscriptionManager**(`params`): [`SubscriptionManager`](#subscriptionmanager)
...
> **new SubscriptionManagerFactory**(): [`SubscriptionManagerFactory`](#subscriptionmanagerfactory)
...
> `static` **newSubscriptionManager**(`params`): `ISubscriptionManager`
