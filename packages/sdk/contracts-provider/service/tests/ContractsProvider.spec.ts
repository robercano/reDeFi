...
describe('ContractsProvider', () => {
  ...
  const mockBlockchainClient = { request: vi.fn() } as any
  ...
  it('should get ERC20 contract through ContractsFactory', async () => {
    ...
    vi.mocked(ContractsFactory.getERC20).mockReturnValue(mockERC20Contract as any)
  ...
  it('should get ERC4626 contract through ContractsFactory', async () => {
    ...
    vi.mocked(ContractsFactory.getERC4626).mockReturnValue(mockERC4626Contract as any)
