...
vi.mock('../src/generated/V4_9_6/ERC20V4_9_6', () => ({
  ERC20V4_9_6: class {
    version = '4.9.6'
    type = 'ERC20'
  },
}))
vi.mock('../src/generated/V4_9_6/ERC4626V4_9_6', () => ({
  ERC4626V4_9_6: class {
    version = '4.9.6'
    type = 'ERC4626'
  },
}))
vi.mock('../src/generated/V4_9_6/ERC1155V4_9_6', () => ({
  ERC1155V4_9_6: class {
    version = '4.9.6'
    type = 'ERC1155'
  },
}))
vi.mock('../src/generated/V4_9_6/ERC721V4_9_6', () => ({
  ERC721V4_9_6: class {
    version = '4.9.6'
    type = 'ERC721'
  },
...
vi.mock('../src/generated/V5_6_1/ERC20V5_6_1', () => ({
  ERC20V5_6_1: class {
    version = '5.6.1'
    type = 'ERC20'
  },
}))
vi.mock('../src/generated/V5_6_1/ERC4626V5_6_1', () => ({
  ERC4626V5_6_1: class {
    version = '5.6.1'
    type = 'ERC4626'
  },
}))
vi.mock('../src/generated/V5_6_1/ERC1155V5_6_1', () => ({
  ERC1155V5_6_1: class {
    version = '5.6.1'
    type = 'ERC1155'
  },
}))
vi.mock('../src/generated/V5_6_1/ERC721V5_6_1', () => ({
  ERC721V5_6_1: class {
    version = '5.6.1'
    type = 'ERC721'
  },
...
describe('ContractsFactory', () => {
  ...
  it('should instantiate V4_9_6 and default versions for ERC20', () => {
    const v4 = ContractsFactory.getERC20({
      ...baseParams,
      version: OpenZeppelinVersion.V4_9_6,
    }) as unknown as { version: string; type: string }
    const v5 = ContractsFactory.getERC20({ ...baseParams }) as unknown as {
      version: string
      type: string
    }
  ...
  it('should instantiate V4_9_6 and default versions for ERC4626', () => {
    const v4 = ContractsFactory.getERC4626({
      ...baseParams,
      version: OpenZeppelinVersion.V4_9_6,
    }) as unknown as { version: string; type: string }
    const v5 = ContractsFactory.getERC4626({ ...baseParams }) as unknown as {
      version: string
      type: string
    }
  ...
  it('should instantiate V4_9_6 and default versions for ERC1155', () => {
    const v4 = ContractsFactory.getERC1155({
      ...baseParams,
      version: OpenZeppelinVersion.V4_9_6,
    }) as unknown as { version: string; type: string }
    const v5 = ContractsFactory.getERC1155({ ...baseParams }) as unknown as {
      version: string
      type: string
    }
  ...
  it('should instantiate V4_9_6 and default versions for ERC721', () => {
    const v4 = ContractsFactory.getERC721({
      ...baseParams,
      version: OpenZeppelinVersion.V4_9_6,
    }) as unknown as { version: string; type: string }
    const v5 = ContractsFactory.getERC721({ ...baseParams }) as unknown as {
      version: string
      type: string
    }
