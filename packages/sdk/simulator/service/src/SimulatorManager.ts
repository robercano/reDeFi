...
import { LiquiditySimulatorManager } from './LiquiditySimulatorManager'
...
export class SimulatorManager implements ISimulatorManager {
  ...
  constructor(
    ...
    this.liquidity = new LiquiditySimulatorManager(protocolManager, blockchainManager)
  }
}
