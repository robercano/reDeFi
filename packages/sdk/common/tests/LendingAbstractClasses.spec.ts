...
class MockLendingPoolId extends LendingPoolId {
  ...
  static create(params: Record<string, unknown>) {
    return new MockLendingPoolId(params)
  }
}
...
class MockLendingPool extends LendingPool {
  ...
  constructor(params: Record<string, unknown>) {
    super(params as never)
    this.collateralToken = params.collateralToken as Token
    this.debtToken = params.debtToken as Token
  }
  static create(params: Record<string, unknown>) {
    return new MockLendingPool(params)
  }
}
...
class MockLendingPoolInfo extends LendingPoolInfo {
  ...
  static create(params: Record<string, unknown>) {
    return new MockLendingPoolInfo(params)
  }
}
...
class MockLendingPositionId extends LendingPositionId {
  ...
  static create(params: Record<string, unknown>) {
    return new MockLendingPositionId(params)
  }
  toString() {
    return 'MockLendingPositionId'
  }
}
...
class MockLendingPosition extends LendingPosition {
  ...
  static create(params: Record<string, unknown>) {
    return new MockLendingPosition(params)
  }
}
