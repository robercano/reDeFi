...
describe('User', () => {
  it('should create a User from parameters', () => {
    ...
    const wallet = Wallet.createFrom({ address: Address.createFromEthereum({ value: '0x1234567890123456789012345678901234567890' }) })
  ...
  it('should evaluate equality correctly', () => {
    const chainInfo = getChainInfoByChainId(1)
    const wallet1 = Wallet.createFrom({ address: Address.createFromEthereum({ value: '0x1234567890123456789012345678901234567890' }) })
    const wallet2 = Wallet.createFrom({ address: Address.createFromEthereum({ value: '0x0987654321098765432109876543210987654321' }) })
