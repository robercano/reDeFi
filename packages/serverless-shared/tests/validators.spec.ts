...
describe('validators', () => {
  it('addressSchema', () => {
    expect(addressSchema.parse('0x0000000000000000000000000000000000000001')).toBe(
  ...
  it('poolIdSchema', () => {
    expect(
      poolIdSchema.parse('0x1234567890123456789012345678901234567890123456789012345678901234'),
    ).toBe('0x1234567890123456789012345678901234567890123456789012345678901234')
  ...
  it('addressesSchema', () => {
    ...
    expect(() =>
      addressesSchema.parse('invalid,0x0000000000000000000000000000000000000002'),
    ).toThrow()
  })
