...
import { addresses, getOneInchOracle, services } from '../constants/addresses'
    ...
    if (
      ...
      return new TokenPrice(
        oneInchResult.value
          ...
          .times(BigIntConstants.TEN.pow(token.decimals.toI32() as u8))
          .div(quotePrecision)
          .toBigDecimal()
